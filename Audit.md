...
- This report was generated by Cake.AddinDiscoverer DEBUG on Sunday, May 6, 2018 at 7:18:22 PM GMT
...
- `Maintainer` indicates who is maintaining the source for this project
- `Transferred to cake-contrib` indicates if the project has been move to the cake-contrib uthub organisation.
